...
### - School Summary Impact
  ...
  The impact of removing the 9th grader scores from the Thomas High School data set is pretty high with a drop in the overall passing of 25% (from 91% to 65%).
